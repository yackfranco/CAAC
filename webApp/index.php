...
<html ng-app="CAAC">
    ...
    <body>
        ...
        <script src="app/controller/controller.consultasreportesdatos2.js" type="text/javascript"></script>
        <script src="app/controller/controller.consultasreportesgraficas2.js" type="text/javascript"></script>
        <script src="app/controller/controller.controlAbejaReina.js" type="text/javascript"></script>
        <script src="app/controller/controller.controlApiarios.js" type="text/javascript"></script>
        <script src="app/controller/controller.controlGastos.js" type="text/javascript"></script>
